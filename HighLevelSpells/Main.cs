...
namespace HighLevelSpells
{
    public static class Main
    {
        ...
        internal static void OnGameReady()
        {
            ...
            //
            skeleton.GuiPresentation.Title = "HighLevelSpells/&FancySkeletonTitle";
            skeleton.GuiPresentation.Description = "HighLevelSpells/&FancySkeletonDescription";
        }
    }
}
